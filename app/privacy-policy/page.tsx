...
export const metadata: Metadata = {
  ...
  description:
    "IKODIO Privacy Policy - How we collect, use, and protect your data",
};
          ...
          <div className="prose prose-invert max-w-none">
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Welcome to IKODIO ("we," "our," or "us"). We are committed to
                protecting your personal information and your right to privacy.
                This Privacy Policy explains how we collect, use, disclose, and
                safeguard your information when you use our AI-powered stock
                prediction platform.
              </p>
              <p className="text-zinc-300 leading-relaxed">
                By using IKODIO, you agree to the collection and use of
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                ...
                <li>
                  KYC (Know Your Customer) information as required by Indonesian
                  regulations
                </li>
              ...
              <h3 className="text-xl font-semibold text-white mt-6 mb-3">
                2.2 Trading and Investment Information
              </h3>
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                ...
                <li>
                  To personalize your experience and provide customized
                  recommendations
                </li>
                <li>To process transactions and manage your account</li>
                <li>
                  To send you notifications, updates, and marketing
                  communications
                </li>
                ...
                <li>
                  To analyze usage patterns and conduct research and development
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                <li>
                  Cloud hosting and infrastructure providers (Vercel, AWS)
                </li>
                <li>Payment processors and financial service providers</li>
                <li>
                  AI and machine learning service providers (Google Gemini AI)
                </li>
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                or legal process, or to protect the rights, property, or safety
                of IKODIO, our users, or others.
              </p>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                longer retention period is required by law. When information is
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                countries other than Indonesia. We ensure that appropriate
            ...
            <section className="space-y-4 mb-8">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">
                13. Compliance with Indonesian Regulations
              </h2>
              <p className="text-zinc-300 leading-relaxed">
                IKODIO complies with Indonesian data protection laws and
              ...
              <p className="text-zinc-300 leading-relaxed mt-4">
                ...
                protection and privacy for our Indonesian users.
              </p>
            </section>
          </div>
        </div>
