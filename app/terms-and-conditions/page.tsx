...
export const metadata: Metadata = {
  ...
  description:
    "IKODIO Terms and Conditions - Legal terms for using our platform",
};
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="space-y-8">
          <div>
            ...
            <p className="text-zinc-400">Last Updated: November 4, 2025</p>
          </div>
          ...
          <div className="prose prose-invert max-w-none">
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                Welcome to IKODIO. By accessing or using our AI-powered stock
                prediction platform ("Platform"), you agree to be bound by these
                Terms and Conditions ("Terms"). If you do not agree to these
                Terms, please do not use our Platform.
              </p>
              <p className="text-zinc-300 leading-relaxed">
                These Terms constitute a legally binding agreement between you
                ("User," "you," or "your") and IKODIO ("we," "us," or "our"). We
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                IKODIO provides an AI-powered stock prediction platform that
                offers:
              </p>
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                <li>
                  Real-time stock price predictions using LSTM neural networks
                </li>
                <li>
                  Technical analysis with 14+ indicators (RSI, MACD, Bollinger
                  Bands, etc.)
                </li>
                ...
                <li>
                  Market analytics and insights for Indonesian stocks (IDX)
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                ...
                <li>
                  Not be prohibited from using our services under Indonesian law
                </li>
                <li>Provide accurate and complete registration information</li>
                <li>
                  Complete KYC (Know Your Customer) verification as required by
            ...
            <section className="space-y-4 mb-8">
              <h2 className="text-2xl font-semibold text-white mt-8 mb-4">
                4. Investment Disclaimer and Risk Warning
              </h2>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6 my-6">
                ...
                <p className="text-zinc-200 leading-relaxed mb-3">
                  <strong>
                    IKODIO provides predictions and analysis tools for
                ...
                <ul className="list-disc list-inside space-y-2 text-zinc-200 ml-4">
                  <li>
                    All predictions are based on AI algorithms and historical
                    data, which may not accurately predict future market
                    movements
                  </li>
                  <li>
                    Stock trading involves substantial risk of loss and is not
                  ...
                  <li>
                    We are not registered as investment advisors with OJK or any
                    regulatory body
                  </li>
                  <li>
                    Always conduct your own research and consult with licensed
              ...
              <p className="text-zinc-300 leading-relaxed">
                While we strive to provide accurate predictions using advanced
                AI technology, we make no warranties or guarantees regarding:
              </p>
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                <li>
                  The accuracy, reliability, or completeness of predictions
                </li>
                <li>The timeliness of data and information provided</li>
                <li>
                  The profitability of any trading strategy based on our
                  predictions
                </li>
                <li>
                  The suitability of our platform for your specific investment
                  goals
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                IKODIO offers various subscription tiers with different features
                and pricing. Current pricing is displayed on our website and may
                be changed with 30 days' notice.
              </p>
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                ...
                <li>
                  Manipulate or interfere with the proper functioning of the
                  Platform
                </li>
                ...
                <li>
                  Use the Platform to manipulate stock prices or engage in
                  market manipulation
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed mt-4">
                are owned by IKODIO and are protected by Indonesian and
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                (watchlists, notes, etc.). By submitting content, you grant us a
                worldwide, non-exclusive, royalty-free license to use,
                reproduce, and display such content as necessary to operate the
                Platform.
              </p>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                and Indonesian data protection laws (UU PDP No. 27 of 2022).
              </p>
              <p className="text-zinc-300 leading-relaxed mt-4">
                We implement industry-standard security measures, but cannot
                guarantee absolute security. You acknowledge that internet
                transmission is never completely secure and use our Platform at
                your own risk.
              </p>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <ul className="list-disc list-inside space-y-2 text-zinc-300 ml-4">
                <li>
                  IKODIO is provided "AS IS" and "AS AVAILABLE" without
                ...
                <li>
                  We are not responsible for investment losses, trading losses,
                ...
                <li>
                  We are not responsible for third-party content, services, or
                  actions
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                You agree to indemnify, defend, and hold harmless IKODIO, its
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                using the account cancellation feature.
              </p>
              ...
              <p className="text-zinc-300 leading-relaxed">
                Upon termination, your right to access the Platform immediately
                ceases. We may delete your account data, but are not obligated
                to do so. Provisions that by their nature should survive
                termination (including liability limitations, indemnification,
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                services, or content. We do not endorse, control, or assume
                responsibility for any third-party services. Your use of
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                laws of the Republic of Indonesia, without regard to conflict of
                law principles.
              </p>
              ...
              <ol className="list-decimal list-inside space-y-2 text-zinc-300 ml-4">
                ...
                <li>
                  Arbitration in accordance with Indonesian arbitration laws
                </li>
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                IKODIO operates in compliance with Indonesian laws and
            ...
            <section className="space-y-4 mb-8">
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                entire agreement between you and IKODIO regarding your use of
                the Platform.
              </p>
              ...
              <p className="text-zinc-300 leading-relaxed">
                ...
                including natural disasters, war, terrorism, pandemics, internet
            ...
            <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6 mt-8">
              <p className="text-zinc-200 leading-relaxed">
                <strong>
                  By using IKODIO, you acknowledge that you have read,
