...
export function PricingSection({ onGetStarted }: PricingSectionProps) {
  ...
  React.useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Popular card - Subtle highlight (no infinite animation)
      const popularCard = cardsRef.current?.querySelector(
        '[data-popular="true"]'
      );
      if (popularCard) {
      ...
      // Hover interactions - Smooth and subtle
